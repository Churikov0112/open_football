...
const PEN_RUNUP_DIST := 2.36          # разбег таза к контакту (мировые метры), кладём бьющего на неё назад
const PEN_ROOT_SCALE := 0.0367        # raw get_root_motion_position → игровые метры (Hips-трек в сырых единицах)
const PEN_CONTACT_TIME := 1.0          # кадр контакта клипа penalty_kick_* (сек), клип ~1.53с
