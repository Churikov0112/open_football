...
`1/2/3` дают бег с тремя скоростями, а не «шаг → бег». Различие скоростей видно в поле `v=` HUD.
...
персонажа вправо). Скорость — дискретно в `_UnhandledKeyInput`. HUD печатает имя текущего клипа,
`quadrant_id`, номер кадра, состояние (скорость/угол) и саму команду. Жёлтая стрелка над палочником —
визуализация команды. Ввод — не `InputMap`: сцена не участвует в `_setup_inputs()` матча, конфликтов с
игровыми биндингами нет.
