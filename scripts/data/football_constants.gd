...
const MAGNUS_FORCE := 50.0       # масштаб бокового/подъёмного импульса кручения в полёте (кручёный удар — Фаза 1)
const MAGNUS_DECAY := 0.99       # затухание вектора _curl за физкадр
