...
const FK_POWER_MIN_SPEED := 26.0      # скорость мяча при мин. заряде, м/с (штрафные с дистанции — сильные)
...
const FK_CURL_SCALE := 18.0           # накопленный боковой ввод стика → величина curl.z
const FK_CURL_MAX := 22.0             # кламп |curl.z|
const FK_PASS_SPEED := 24.0           # скорость наземного паса штрафного, м/с
const FK_LOB_MIN_DIST := 10.0         # мин. дальность приземления навеса вдоль направления, м
const FK_LOB_MAX_DIST := 42.0         # макс. дальность приземления навеса, м
# Стенка.
