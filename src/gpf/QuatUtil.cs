...
namespace Gpf
{
    ...
    public partial class QuatUtil : RefCounted
    {
        ...
        // Портируем bug-for-bug: в оригинале SetAngles с GetAngles в паре и не используется —
        // единственный вызов ball.cpp:512 строит кватернион из вектора вращения мяча.
